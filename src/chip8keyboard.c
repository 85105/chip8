...
void chip8_keyboard_down(struct chip8_keyboard *keyboard, int key) // int key is virtual key
{
    keyboard->keyboard[key] = true;
}
void chip8_keyboard_up(struct chip8_keyboard *keyboard, int key) // int key is virtual key
{
    keyboard->keyboard[key] = false;
}
bool chip8_keyboard_is_down(struct chip8_keyboard *keyboard, int key) // int key is virtual key
{
